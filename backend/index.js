...
app.post('/api/public/visit', analyticsController.recordVisit);
app.get('/api/public/visit', analyticsController.getVisitStats);
...
server.on('error', (err) => {
  if (err.code === 'EADDRINUSE') {
    console.log(`[Server Notice] Port ${PORT} is already active. API endpoints ready at http://localhost:${PORT}/api`);
  } else {
